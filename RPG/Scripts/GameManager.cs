...
public class GameManager : Node
{
    ...
    public int GetDifficulty() {return difficulty;} public void SetDifficulty(int a) {difficulty = a; GetNode<BattleManager>("TurnQueue").GiveFirstTurn(); GetNode<GUI>("UI").HideSetupMenu();}
